...
/// Swift implementation. ObjC `FlutterContactsPlugin` in Classes/ bridges to this
/// so GeneratedPluginRegistrant.m does not see the same symbol in two modules
/// (flutter_contacts vs flutter_contacts.Swift) under static frameworks.
public class SwiftFlutterContactsPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        registrar.addMethodCallDelegate(SwiftFlutterContactsPlugin(), channel: channel)
