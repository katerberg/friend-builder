...
Fast, complete contact management for Android, iOS & macOS — all fields, groups, accounts, vCards, native dialogs, listeners, SIM contacts, and number blocking.
  ...
  # ObjC shim (Classes/) + Swift sources. The shim avoids
  # "FlutterContactsPlugin has different definitions in different modules"
  # when Runner's GeneratedPluginRegistrant.m imports the plugin under
  # use_frameworks! :linkage => :static.
  s.source_files = 'Classes/**/*.{h,m}', 'flutter_contacts/Sources/flutter_contacts/**/*.swift'
